...
#var dead = false
var dead_time = 10 # время существования трупа босса
var life_time = 600 # # время жизни босса
func _ready():
	dead = false
	speed = default_speed
	self.hp = 500
...
#	add_to_group(Global_DataParser.boss_group)
...
#	attack_on()
#	attack_on()	
#	SoundPlayer.play(preload("res://audio/sounds/menuTheme.ogg"))
...
func die1():
	dead = true	
#	print("Paladin Dead")
#	Global_DataParser.dec_kobold(1)
	cancel_movement()
	set_process(false)
...
#		_data = inventory_add_item(2,10,_data)
#		_data = inventory_add_item(3,4,_data)
#		_data = inventory_add_item(4,3,_data)

#		return	
	

		var a = load("res://Scenes/Damage/Mobs_Player/DamageAreaFireLight_Dark.tscn").instance()
		var dmg = 500

...
func _ready():
	...
	$BlockingDialogBox.append_text("Welcome to Farm",15,36)	
	yield($BlockingDialogBox, "box_hidden")
	$BlockingDialogBox.append_text("Population of 12 people", 20,36)
	yield($BlockingDialogBox, "box_hidden")
	$BlockingDialogBox.append_text("Here live the most ordinary people", 20,36)
	yield($BlockingDialogBox, "box_hidden")

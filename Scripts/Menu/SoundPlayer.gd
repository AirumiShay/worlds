...
var count = 0
var sound_player_scene = load("res://Scenes/Menu/AudioStreamPlayer.tscn")

var load_sound_path = "res://audio/sounds/preload_sfx/"
var loaded_sounds = {}
...
func play(sound, volume=0):
	...
	if GlobalData.boolSound:
		...
		# Set volume
		scene_instance.set_volume_db((10 * log(GlobalData.Sound))+volume)
		# Start playing

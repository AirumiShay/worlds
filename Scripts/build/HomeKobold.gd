...
func rpc_spawn_mobs(): #(nickname:String, data:Dictionary, die_position:Vector2, url_data:String="") -> void:
	if get_tree().is_network_server():
		var object_path = 'res://Scenes/AngryAnimal.tscn'
		Global_Network.spawn_object(get_tree().get_network_unique_id(),object_path,self.position,"Wolf",Global_DataParser.join_race,Global_DataParser.location_number)
...
func get_data():
	...
	_new_data["whoiam"] ="res://Scenes/Build/HomeKobold.tscn"
	_new_data["nickname"] ="HomeKobold"
	return _new_data

...
#	print("spawning stage 1")
	var town = load('res://Scenes/Race/Elf_Merchant.tscn').instance()
	town.name = nickname + "_" + str(Global_DataParser.rng.randi())
#	print(town.name)
	print("spawning elf merchant")
#	bag.name = nickname
...
#	bag.name = nickname
	...
	town1.position = die_position - Vector2(256,256)
...
#		print("all spawning Local Paladin in Temple =")
		Global_DataParser.inc_mobs(12,1)	
...
func get_data():
	...
	_new_data["whoiam"] ="res://Scenes/Build/TowerElf.tscn"
	_new_data["nickname"] ="TowerElf"

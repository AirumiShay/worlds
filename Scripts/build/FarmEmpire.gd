...
#		Global_DataParser.build_farm += 1
		var transfer = prepare_data_start(0)		
		Global_Network.spawn_object(get_tree().get_network_unique_id(),object_path,posXY,"FarmEmpire",Global_DataParser.join_race,location_number,transfer)
...
func rpc_spawn_castle(posXY): 
	if get_tree().is_network_server():	 
		var object_path = 'res://Scenes/Build/Castle.tscn'
...
func get_data():
	...
	_new_data["whoiam"] ="res://Scenes/Build/FarmEmpire.tscn"
	_new_data["nickname"] ="FarmEmpire"

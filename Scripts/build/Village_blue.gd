...
#это здание - Гарнизон  Outpostб производит юнит - рыцарь(Империя) Knight
...
var spawn = false
var spawn_time = 180#время рождения рыцарей
...
func get_data():
	...
	_new_data["whoiam"] ="res://Scenes/Build/Outpost.tscn"
	_new_data["nickname"] ="Outpost"
	return _new_data

...
#	print("after spawn")
	...
	rpc_spawn_mobs()
	update_hp()		
	Global_DataParser.build_fortress_dark += 1
	location_number = Global_DataParser.location_number			

func rpc_spawn_avanpost_demon(posXY):
	if get_tree().is_network_server():	 
		var object_path = "res://Scenes/Race/DarkRider.tscn"
...
func rpc_spawn_mobs(): #(nickname:String, data:Dictionary, die_position:Vector2, url_data:String="") -> void:
	rpc_spawn_avanpost_demon(self.position)
	return
...
#	print("spawning stage 1")
	var town = load('res://Scenes/Race/DarkRider.tscn').instance()
...
func get_data():
	...
	_new_data["whoiam"] ="res://Scenes/Build/FortressDarkElf.tscn"
	_new_data["nickname"] ="FortressDemon"
	return _new_data

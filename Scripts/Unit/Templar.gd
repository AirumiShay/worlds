...
func set_resurect():
	if 	dead != false:
		...
		update_hp()
		count_attack = 200	
		$Sprite.texture = load("res://Assets/units_new/unit_human_massacre_zombi.png")			
		set_process(true)	
...
#
		...
		if count_attack < 0 and npc_god == false:
			die1()
func attack_on1():
...
func get_data():
	...
	_new_data["whoiam"] ="res://Scenes/Race/Templar.tscn"
	_new_data["nickname"] ="Templar"
	return _new_data

...
#var dead = false
var dead_time = 60 # время существования трупа Rogue
var life_time = 180 # # время жизни Rogue
func _ready():
	dead = false
	speed = default_speed
	self.hp = 3000
...
func wander():
	...
	if stands:
		randomize()
		x = int(rand_range(pos.x - 250, pos.x + 250))
		y = int(rand_range(pos.y - 250, pos.y + 250))

...
#это моб низший зомби  Zombi_low.tscn
var stands = false
...
func attack_play():
		...
		a.position = self.position # $DamagePos.position #разброс попадания в цель
func attack_play2():
		...
		a.position = self.position # $DamagePos.position #разброс попадания в цель
func attack_play3():
		var a = load("res://Scenes/Damage/DamageAnimalMobPlayer.tscn").instance()
		var dmg = 25
#		a.set_damage(dmg)
#		a.set_parent_is(self)
		get_parent().add_child(a)
...
func get_data():
	...
	_new_data["whoiam"] ="res://Scenes/Race/Zombi_low.tscn"
	_new_data["nickname"] ="ZombiLow"
	return _new_data

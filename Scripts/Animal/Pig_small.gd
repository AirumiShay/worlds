...
#		var a = load("res://Scenes/DamageAreaLight.tscn").instance()
		var a = load("res://Scenes/Village_blue.tscn").instance()
#		var dmg = 2
...
#		get_parent().add_child(a)
		$'/root/Game/BuildFarm'.add_child(a)
...
#	attack_on()	
#	$TimerNewBuild.start(30)	# Replace with function body.
